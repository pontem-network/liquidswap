...
module liquidswap::router_tests {
    ...
    fun test_add_initial_liquidity() {
        let (coin_admin, lp_owner, pool_addr) = register_pool_with_liquidity(0, 0);
    ...
    fun test_add_liquidity_to_pool() {
        let (coin_admin, lp_owner, pool_addr) = register_pool_with_liquidity(101, 10100);
    ...
    fun test_remove_liquidity() {
        let (_, lp_owner, pool_addr) = register_pool_with_liquidity(101, 10100);
    ...
    fun test_swap_exact_coin_for_coin() {
        let (coin_admin, _, pool_addr) = register_pool_with_liquidity(101, 10100);
    ...
    fun test_swap_exact_coin_for_coin_1() {
        let (coin_admin, _, pool_addr) = register_pool_with_liquidity(1230000000, 147600000000);
    ...
    fun test_stable_curve_swap_exact_3() {
        let (coin_admin, lp_owner, pool_addr) = register_stable_pool_with_liquidity(2930000000000, 293000000000000);
    ...
    fun test_calc_optimal_coin_values() {
        ...
        let (_, _, pool_addr) = register_pool_with_liquidity(10000000000, 2800000000000);
    ...
    fun test_calc_optimal_coin_values_3() {
        // 100 BTC, 28000 USDT
        let (_, _, pool_addr) = register_pool_with_liquidity(10000000000, 28000000000);
