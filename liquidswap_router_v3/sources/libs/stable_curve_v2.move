...
module liquidswap::stable_curve_v2 {
    ...
    public fun coin_out(coin_in: u64, scale_in: u64, scale_out: u64, reserve_in: u128, reserve_out: u128): u64 {
        let u2561e8 = u256::from_u128(ONE_E_8);
    ...
    /// * `reserve_out` - reserves of coin to get in exchange.
    public fun coin_in(coin_out: u64, scale_out: u64, scale_in: u64, reserve_out: u128, reserve_in: u128): u64 {
        let u2561e8 = u256::from_u128(ONE_E_8);
        ...
        let x = u256::sub(
            get_y_up(total_reserve, xy, reserve_in_u256),
            reserve_in_u256,
        );
        let r = div_up_u256(
            u256::mul(
    ...
    /// * `xy` - lp value (see `lp_value` func).
    /// * `y` - reserves y with transformed decimals.
    fun get_y_up(x0: U256, xy: U256, y: U256): U256 {
        let i = 0;
