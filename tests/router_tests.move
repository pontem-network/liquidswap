...
module liquidswap::router_tests {
    ...
    fun register_x2_pool_with_liquidity(x0_val: u64, y0_val: u64, x1_val: u64, y1_val: u64): (signer, signer) {
        let (coin_admin, lp_owner) = register_pool_with_liquidity(x0_val, y0_val);
    ...
    fun test_swap_coin_for_coin_unchecked_x2() {
        ...
        let usdc_coins = router::swap_coin_for_coin_unchecked_x2<BTC, USDT, USDC, Uncorrelated, Stable>(
            btc_coins_to_swap,
            usdc_amount_out
        );
    ...
    fun test_swap_coin_for_coin_unchecked_x3() {
        ...
        let eth_coins = router::swap_coin_for_coin_unchecked_x3<BTC, USDT, USDC, ETH, Uncorrelated, Stable, Uncorrelated>(
            btc_coins_to_swap,
            eth_amount_out
        );
